...
CLASS zcl_timem_syntax_highlighter DEFINITION LOCAL FRIENDS ltcl_syntax_cases.
...
CLASS ltcl_syntax_cases DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mt_after_parse  TYPE zcl_timem_syntax_highlighter=>ty_match_tt,
      mt_after_order  TYPE zcl_timem_syntax_highlighter=>ty_match_tt,
      mt_after_extend TYPE zcl_timem_syntax_highlighter=>ty_match_tt,
      ms_match        TYPE zcl_timem_syntax_highlighter=>ty_match.
...
CLASS zcl_timem_syntax_highlighter DEFINITION LOCAL FRIENDS ltcl_syntax_basic_logic.
...
CLASS ltcl_syntax_basic_logic DEFINITION FINAL FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    DATA mo_syntax_highlighter TYPE REF TO zcl_timem_syntax_highlighter.
...
CLASS ltcl_syntax_basic_logic IMPLEMENTATION.
  ...
  METHOD setup.
    mo_syntax_highlighter = zcl_timem_syntax_highlighter=>create( '*.abap' ).
  ENDMETHOD.
  ...
  METHOD apply_style.
    ...
    lv_line_act = mo_syntax_highlighter->apply_style( iv_line  = 'CALL FUNCTION' "#EC NOTEXT
                                   iv_class = zcl_timem_syntax_abap=>c_css-keyword ).
