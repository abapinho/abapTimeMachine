...
public section.
  ...
  class-methods CREATE
    ...
    returning
      value(RO_INSTANCE) type ref to ZCL_BLAME_SYNTAX_HIGHLIGHTER .
...
CLASS ZCL_BLAME_SYNTAX_HIGHLIGHTER IMPLEMENTATION.
  ...
  METHOD CREATE.
    ...
    IF iv_filename CP '*.abap'.
      CREATE OBJECT ro_instance TYPE zcl_blame_syntax_abap.
    ELSE.
      CLEAR ro_instance.
    ENDIF.
